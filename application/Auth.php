...
class Auth extends CI_Controller {
	...
	{
		// Check if user is already log in or not
      ...
      if ($this->ion_auth->is_admin()) {
		...
		else
		{
			...
			$this->template->set('title', 'WebApp Fire | Log in');
			$this->template->load('auth/template', 'auth/login', $this->data);
		}
	...
	public function forgot_password()
	{
		...
		if ($this->form_validation->run() == FALSE) {
				...
				$this->template->set('title', 'WebApp Fire | Forgot Password');
      ...
      else
      {
          ...
          $this->data['password_confirm'] = array(
            ...
            'class' => 'form-control',
				...
				$this->template->set('title', 'WebApp Fire | Register');
        $this->template->load('auth/template', 'auth/register', $this->data);
      }
	}
