 ...
 ***************************************************************************************************************** -->
 ...
 <div class="container mtb" style="padding-top: 25px;">
  <div class="row">
    <div class="col-lg-6">
      <img class="img-responsive" src="<?php echo base_url('solid/assets/img/agency.jpg'); ?>" alt="">
    </div>
    ...
    <div class="col-lg-6">
      ...
      <p>
        ...
        Satuan Kredit Kegiatan Mahasiswa (SKKM) merupakan kredit poin yang harus dipenuhi oleh mahasiswa ketika menempuh pendidikan di kampus Politeknik Negeri Bali.
