      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse navbar-right">
          <ul class="nav navbar-nav">
            <li class="<?php echo ($this->uri->segment(1)==='beranda')? 'active':'' ;?>"><a href="<?php echo site_url('beranda'); ?>">BERANDA</a></li>
            <li class="<?php echo ($this->uri->segment(1)==='tentang')? 'active':'' ;?>"><a href="<?php echo site_url('tentang'); ?>">TENTANG</a></li>
            <li class="<?php echo ($this->uri->segment(1)==='pengumuman')? 'active':'' ;?>"><a href="<?php echo site_url('pengumuman'); ?>">PENGUMUMAN</a></li>
            <li class="<?php echo ($this->uri->segment(1)==='kontak')? 'active':'' ;?>"><a href="<?php echo site_url('kontak'); ?>">KONTAK</a></li>
